...
NVIDIA NIM model latency benchmarker. Single-binary, written in Nim. v0.15.0. 88-model catalog with SWE-bench scores, stability scoring, and oh-my-opencode routing recommendations.
