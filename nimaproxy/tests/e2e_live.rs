...
fn get_test_keys() -> Vec<(String, String)> {
    vec![
        ("nvapi-REDACTED_DOLTARES_KEY".to_string(), "doltares".to_string()),
        ("nvapi-REDACTED_ARES_KEY".to_string(), "ares".to_string()),
        ("nvapi-REDACTED_BACKUP_KEY".to_string(), "dirmacs".to_string()),
    ]
}
